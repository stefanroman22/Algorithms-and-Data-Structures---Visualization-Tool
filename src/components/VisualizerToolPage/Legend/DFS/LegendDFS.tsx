  ...
  return (
    <div className="legend-container">
      <div className="legend">
        ...
        <div>
          <span className="edge-forward"></span>Edge: Forward
        </div>
        <div>
          <span className="edge-back"></span>Edge: Back Edge
        </div>
        <div>
          <span className="edge-cross"></span>Edge: Cross
        </div>
      </div>
      ...
      <div className="legend-color-blind">
        ...
        <div>
          <span className="edge-forward-color-blind"></span>Edge: Forward
        </div>
        <div>
